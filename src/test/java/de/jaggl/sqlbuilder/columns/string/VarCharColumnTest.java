...
class VarCharColumnTest extends ColumnTestSupport<VarCharColumn, VarCharColumnBuilder>
{
    @Override
    ...
    @Override
    protected BiFunction<VarCharColumn, String, VarCharColumn> getAliasFunction()
    {
